...
<body>
    ...
    <main>
        ...
        <div class="container1">
            ...
            <div class="options1">
                <div class="view1">
                    <a href="/Hinata/<?php echo $img; ?>">
                        <p>View</p>
                    </a>
                </div>
                <div class="download1">
                    <a href="/Hinata/<?php echo $img; ?>" download="<?php echo $imgname; ?>">
                        <p>Download</p>
                    </a>
                </div>
        ...
        <div class="container">
            <?php
            $sqlshow = "SELECT * FROM `images` Limit 8";
        ...
        <div class="options">
        <div class="view">
          <a href="/Hinata/viewImg.php?imgid='.$row['id'].'"><P>View</P></a>
        </div>
